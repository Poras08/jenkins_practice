        ...
        stage('Show') {
            steps {
                  sh label:"List all images",
                     script: """
                             gcloud auth activate-service-account poras08@uplifted-plate-316209.iam.gserviceaccount.com  --key-file=jenkins_practice/path/key.json --project=testproject
